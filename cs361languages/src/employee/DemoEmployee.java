...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
        ...
        emp3.whoAmI();
        // TODO To complete
        // emp3.whoAmI() // prints PartTimeEmployee because emp3 is set equal to PartTimeEmployee
        //
        // emp3.getHourlyRate(); // returns syntax error because you can only call methods from the Employee class
        ...
        // because you assign a PartTimeEmployee object to a Employee object
